...
#Number of people by Slope and target 
select slope,count(slope) as 'Number of People',target 
from cte
group by 1,3
order by 1

#Number of people by ca and target 
select ca,count(ca) as 'Number of People',target 
from cte
group by 1,3
order by 1
...
#Number of people by Thalach and gender 
select thalach,count(thalach) as 'Number of People',sex
from cte
group by 1,3
order by 2 desc 

#Number of people by trestbps and gender
select trestbps,count(trestbps) as 'Number of People',sex
from cte
group by 1,3
order by 2 desc 

#Number of people by cholestarol and gender 
select chol,count(chol) as 'Number of People',sex
from cte
group by 1,3
order by 2 desc 

#Number of people by Thalessemia and gender 
select thal,count(thal) as 'Number of People',sex 
from cte
group by 1,3
order by 1

#Number of people by Chestpain and gender 
...
#Number of people by Restacg and gender 
...
#Number of people by Slope and gender 
select slope,count(slope) as 'Number of People',sex
from cte
group by 1,3
order by 1

#Number of people by ca and gender 
select ca,count(ca) as 'Number of People',sex
from cte
group by 1,3
order by 1
